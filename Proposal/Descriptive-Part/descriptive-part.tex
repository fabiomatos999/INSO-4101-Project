...
\begin{itemize}
  ...
  \item The system-to-be's checkout system has to be synchronous in order to avoid the scenario where the same item is sold to 2 or more different customers.
